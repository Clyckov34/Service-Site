...
//Message состовлет сообщения и оправляет отправителю | раздел обратная связь
func Message(m *Param) string {
	return fmt.Sprintf(`
	<head>
		<style>
	...
	<body>
		<table>
			<tr>
				<td colspan="2" class="Table-Title">Заявка на обратную связь</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="Table-Name-Price" colspan="2">%v</td>
			</tr>
		</table>
	</body>
	`, m.FirstName, m.Phone, m.Phone, m.Email, m.Email, m.Text)
}
